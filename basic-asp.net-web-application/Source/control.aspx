...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="control">
      <asp:Label Text="Default Text1" CssClass="lbltxt1" runat="server"  />
            <asp:TextBox runat="server" CssClass="tboxtxt1"  ID ="txt1"  placeholder="Default page text1" />
            <asp:Label Text="Default Text " CssClass="lbltxt2" runat="server" />
            ...
            <asp:button Text="Save Changes" CssClass="btnchange" runat="server" OnClick="Unnamed9_Click" />
